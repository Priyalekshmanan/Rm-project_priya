                ...
                <div className="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <Link to="./" className="nav-link text-white active bg-gradient-primary">
                        ...
                        <li className="nav-item">
                            ...
                            <ul className="collapse" id="exam-submenu">
                                <li className="nav-item">
                                    <Link to="add-result" className="nav-link text-white">Add Result</Link>
                                </li>
                                <li className="nav-item">
                                    <Link to="view-result" className="nav-link text-white">View Result</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className="nav-item">
                            ...
                            <ul className="collapse" id="registration-submenu">
                                <li className="nav-item">
                                    <Link  className="nav-link text-white" to="student-attendance">
                                    Student Attendance                                
                                    </Link>
                                </li>
                                <li className="nav-item">
