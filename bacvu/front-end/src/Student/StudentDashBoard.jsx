    ...
    <div>
      <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          ...
          <div class="nav-item">
              <a class="nav-link text-white collapsed" href="../pages/billing.html" data-bs-toggle="collapse" data-bs-target="#att-submenu" aria-expanded="false" aria-controls="att-submenu">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">book</i>
                </div>
                <span class="nav-link-text ms-1">Attendance</span>
              </a>
              <ul class="collapse" id="att-submenu">
                <li class="nav-item">
                  <Link to="view-attendance">
                  <a class="nav-link text-white">View Attendance</a>
                  </Link>
                </li>
                <li class="nav-item">
                  <Link to="attendance-report">
                  <a class="nav-link text-white">Attendance Report</a>
                  </Link>
                </li>
              </ul>
          </div>
