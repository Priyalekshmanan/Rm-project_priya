        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          ...
          <div class="nav-item">
              ...
              <ul class="collapse" id="user-submenu">
                <li class="nav-item">
                  <Link to="/Admin-DashBoard/user-registration"> <a class="nav-link text-white" href="#">Registration</a></Link>
                 
                </li>
                <li class="nav-item">
                  <Link to="/Admin-DashBoard/get-all-user"><a class="nav-link text-white" href="#">Get all user</a></Link>
                  
                </li>    
                <li class="nav-item">
                  <Link to="/Admin-DashBoard/delete-user"><a class="nav-link text-white" href="#">Delete user</a></Link>
          ...
          <div class="nav-item">
              ...
              <ul class="collapse" id="class-submenu">
                <li class="nav-item">
                  <Link to="/Admin-DashBoard/assign-classes"> <a class="nav-link text-white" href="#">Assign Teacher</a></Link>         
                      
                </li>
                <li class="nav-item">
                <Link to="/Admin-DashBoard/classes-opera"> <a class="nav-link text-white" href="#">Classes</a></Link>  
                </li>    
              </ul>
          </div> 
           ...
           <div class="nav-item">
              ...
              <ul class="collapse" id="exam-submenu">
                ...
                <li class="nav-item">
                <Link to="/Admin-DashBoard/view-exams"> 
                <a class="nav-link text-white" href="#">
                Exams</a>
                    </Link>
